...
class ChannelsCog(commands.Cog, name="Channel Routing"):
    ...
    async def set_channel(
        ...
        type_descriptions = {
            ...
            "flash": "⚡ Flash News Ze Świata (Auto :05, :35)",
            "flash_news": "⚡ Flash News Ze Świata (Auto :05, :35)",
            "flashnews": "⚡ Flash News Ze Świata (Auto :05, :35)",
    ...
    async def list_channels(self, ctx: commands.Context) -> None:
        ...
        lines = [
            ...
            f"• **⚡ Flash News Ze Świata (Auto :05, :35):** {ch_mention(channels.get('news_global') or self.settings.discord_news_global_channel_id or 1544598484961722409)}",
